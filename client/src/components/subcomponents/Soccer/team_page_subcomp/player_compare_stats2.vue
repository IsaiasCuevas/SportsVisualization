...
export default {
  ...
  data() {
    return {
      series: [
        parseInt(this.p1.player_yellow_cards),
        parseInt(this.p2.player_yellow_cards)
      ],
      chartOptions: {
        labels: [this.p1.player_name, this.p2.player_name],
        responsive: [
          {
            breakpoint: 480,
            options: {
