<template>
  <div>
    ...
    <div v-if="!loading" class="csgo-match-compare">
            ...
            <md-tab md-label="All Maps" class="csgo-match-compare">
              ...
              >
                ...
                >
                  ...
                  <md-table-cell md-label="IGN">{{ item.nickname }}</md-table-cell>
                  <md-table-cell md-label="Kills">{{ item.statistics.kills }}</md-table-cell>
                  <md-table-cell md-label="Deaths">{{ item.statistics.deaths }}</md-table-cell>
                </md-table-row>
              </md-table>
              <md-table
      ...
      <div v-if="home_player">{{home_player}}</div>
      <div v-if="away_player">{{away_player}}</div>
    </div>
  </div>
</template>
